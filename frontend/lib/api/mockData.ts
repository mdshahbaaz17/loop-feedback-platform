...
export const mockFeedback: Feedback[] = [
  { id: 'f1', title: 'Navigation is confusing', description: 'The new sidebar makes it hard to find settings.', authorId: '3', assigneeId: '1', status: 'NEW', priority: 'HIGH', category: 'UI/UX', loopId: 'l1', tags: ['sidebar', 'navigation'], createdAt: new Date(Date.now() - 86400000).toISOString(), updatedAt: new Date().toISOString() },
  { id: 'f2', title: 'Dark mode contrast issues', description: 'Text is hard to read on the secondary background in dark mode.', authorId: '2', assigneeId: '2', status: 'IN_PROGRESS', priority: 'MEDIUM', category: 'Accessibility', loopId: 'l1', tags: ['darkmode', 'design'], createdAt: new Date(Date.now() - 172800000).toISOString(), updatedAt: new Date().toISOString() },
  { id: 'f3', title: 'App crashes on launch', description: 'The mobile app crashes immediately after the splash screen on iOS 17.', authorId: '3', assigneeId: '1', status: 'RESOLVED', priority: 'HIGH', category: 'Bug', loopId: 'l2', tags: ['ios', 'crash'], createdAt: new Date(Date.now() - 259200000).toISOString(), updatedAt: new Date().toISOString() },
];
